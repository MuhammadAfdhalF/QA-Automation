...
WebUI.waitForElementVisible(findTestObject('Admin/Portfolio/Page_Portfolio/drpFilterCategory'), 10)

WebUI.selectOptionByValue(findTestObject('Admin/Portfolio/Page_Portfolio/drpFilterCategory'), 'design', false)

WebUI.delay(1)

WebUI.verifyTextPresent('design', false)
